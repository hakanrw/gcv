// go-system.h -- Vala frontend inclusion of gcc header files   -*- C++ -*-
...
#ifndef VALA_SYSTEM_H
#define VALA_SYSTEM_H
...
// When using gcc, vala_assert is just gcc_assert.
#define vala_assert(EXPR) gcc_assert(EXPR)

// When using gcc, vala_unreachable is just gcc_unreachable.
#define vala_unreachable() gcc_unreachable()

#endif // !defined(VALA_SYSTEM_H)
